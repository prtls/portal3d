 ...
 */
float vec2_dot(vec3_t a, vec2_t b) { return (a.x * b.x) + (a.y * b.y); }
...
/**
 * Return a duplicate of the 3D vector passed in (needed for triangle->polygon
 * conversion in clipping.c)
 */
...
/**
 * Get the cross product of two 3D vectors using the 3D vector cross product
 * formula
 */
...
/**
 * Get the dot product of two 3D vectors using the formula (Ax*Bx + Ay*By +
 * Az*Bz)
 */
