...
void load_obj_file_data(char* filename) {
    ...
    while (fgets(line, 1024, file)) {
        ...
        if (strncmp(line, "f ", 2) == 0) {
            ...
            sscanf(
                // obj data is stored in lines as "f A/B/C A/B/C A/B/C"
                // where A is the vertex index B is the texture index and C is the vertex normal index
            ...
            face_t face = {
                // obj arrays are 1-based, not 0 based, hence the - 1 offset
